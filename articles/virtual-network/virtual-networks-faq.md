...
[!NOTE] Azure VMware Solution is unable to support the use of the Shared Address space reserved in [RFC 6598](https://datatracker.ietf.org/doc/html/rfc6598). Additional details are available within the [Routing and subnet considerations documentation](https://docs.microsoft.com/en-us/azure/azure-vmware/tutorial-network-checklist#routing-and-subnet-considerations) for Azure VMware Solution.
